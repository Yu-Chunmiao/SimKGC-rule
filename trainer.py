...
class Trainer:
    ...
    def __init__(self, args, ngpus_per_node):
        ...
        # ckt_dict = torch.load('checkpoint/WN18RR/checkpoint_epoch37.mdl', map_location=lambda storage, loc: storage)
    ...
    def _run_eval(self, epoch, step=0):
        ...
        filename = '{}/checkpoint_{}_{}.mdl'.format(self.args.model_dir, epoch + 38, step)
        if step == 0:
            filename = '{}/checkpoint_epoch{}.mdl'.format(self.args.model_dir, epoch + 38)
        save_checkpoint({
            'epoch': epoch,
    ...
    def eval_epoch(self, epoch) -> Dict:
        ...
        for i, batch_dict in enumerate(self.valid_loader):
            ...
            logits, loss, labels = outputs.logits, outputs.loss, outputs.labels
